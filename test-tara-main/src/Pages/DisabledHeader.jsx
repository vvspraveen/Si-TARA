...
const DisabledHeader = () => {
    ...
    return (
        <header class="o-header" style={{ width: "100%" }}>
            <div class="o-header__top-container" style={{ width: "100%" }}>
                <div class="e-container" style={{ width: "100%" }}>
                    <div class="o-header__top" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <a class="o-header__logo" aria-label="Bosch Logo" style={{ bottom: 0 }}>
                            <svg
                                width="148px"
                                height="24px"
                                viewBox="0 0 124 24"
                        ...
                        <div class="o-header__quicklinks">
                            <button type="button" class="a-button a-button--integrated" onClick={handleHome} style={{ fontFamily: 'BoschSans', cursor: 'not-allowed' }} disabled>
                                <i
                                    class="a-icon a-button__icon boschicon-bosch-ic-home"
                                    title="Home"
                                    style={{ margin: 0 }}
                                ></i>
                                <span class="a-button__label">Home</span>
                            </button>
                            <a href="https://inside-docupedia.bosch.com/confluence/display/SWEXPROG/Si-TaRA" target="_blank" style={{ cursor: 'not-allowed', pointerEvents: "none", }}>
                                <button type="button" class="a-button a-button--integrated" disabled style={{ cursor: 'not-allowed' }}>
                                    <i
                                        class="a-icon a-button__icon boschicon-bosch-ic-question-frame"
                                        title="About"
                                        style={{ margin: 0 }}
                                    ></i>
                                    <span class="a-button__label">About</span>
                                </button>
                            </a>

                            <button type="button" class="a-button a-button--integrated" onClick={handlecontacts} disabled style={{ cursor: 'not-allowed' }}>
                                <i
                                    class="a-icon a-button__icon boschicon-bosch-ic-chat"
                                    title="Feedback"
                                ></i>
                                <span class="a-button__label">Feedback</span>
                            </button>
                            <button type="button" class="a-button a-button--integrated" onClick={handleAccount} style={{ fontFamily: 'BoschSans', cursor: 'not-allowed' }} disabled>
                                <i
                                    class="a-icon a-button__icon boschicon-bosch-ic-user--setting"
                                    title="Account"
                                ></i>
                                <span class="a-button__label">Account</span>
                            </button>
                            <button type="button" class="a-button a-button--integrated" onClick={handleLogout} style={{ fontFamily: 'BoschSans', cursor: 'not-allowed' }} disabled>
                                <i
