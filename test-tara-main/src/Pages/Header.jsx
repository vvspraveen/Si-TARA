                ...
                <div class="e-container" style={{ width: "100%" }}>
                    <div class="o-header__top" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <div class="o-header__quicklinks">
                            <button type="button" class="a-button a-button--integrated" onClick={handleHome} style={{ fontFamily: 'BoschSans' }}>
                                <i
                            ...
                            <a href="https://inside-docupedia.bosch.com/confluence/display/SWEXPROG/Si-TaRA" target="_blank">
                            ...
                            <button type="button" class="a-button a-button--integrated" onClick={handlecontacts}>
                                <i
                            ...
                            <button type="button" class="a-button a-button--integrated" onClick={handleAccount} style={{ fontFamily: 'BoschSans' }}>
                                <i
                            ...
                            <button type="button" class="a-button a-button--integrated" onClick={handleLogout} style={{ fontFamily: 'BoschSans' }}>
                                <i
