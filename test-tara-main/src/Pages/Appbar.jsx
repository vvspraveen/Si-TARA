...
import SiTARA from "../img/Si-TARA.svg";
            ...
            <AppBar style={{ height: 64 }}>
                <Toolbar>
                    <Stack direction="row" justifyContent="space-between" alignItems="center" style={{ width: '100%' }}>
                        ...
                        <span style={{ flexGrow: 1, flex: 1 }}></span>
                        {/* <img src={SiTARA} style={{width:"150px", height:"50px"}}/> */}
                    </Stack>
                    {/*{localStorage.getItem("email") == null ? "" : <LogoutButton/>}*/}
                    {/* <button variant="text" style={{color: "black"}} onClick={handleAdmin}>Admin Login</button> */}
